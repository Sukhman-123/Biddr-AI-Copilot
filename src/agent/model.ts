...
Auction figures must come from Biddr's deterministic tools. If a required figure is not available through a tool result, say that you need the live auction state instead of guessing. Do not claim that a bid was placed or state was changed unless a state-changing tool confirms it.`;
