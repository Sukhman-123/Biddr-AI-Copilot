/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: d49c67a134321c02f849257a7b051f85)
// Runtime types generated with workerd@1.20260918.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	BiddrCopilotAgent: DurableObjectNamespace<import("./src/server").BiddrCopilotAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BiddrCopilotAgent";
	}
